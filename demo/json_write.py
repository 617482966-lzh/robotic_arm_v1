...
class HC1JsonRobot:
    ...
    def _build_free_path_inst(self, j1, j2, j3, j4, j5, j6,
        ...
        自由路径: m0-m7 对应关节角 J1-J8 (deg)
        ck_status: 轴掩码, bit1=J1, bit2=J2 ... 0x3F = 前6轴
        """
        return {
            "oneshot": "1" if one_shot else "0",
            "action": "4",
    ...
    def move_free_path(self, j1, j2, j3, j4, j5, j6,
        ...
        参数:
            ...
            ck_status: 轴掩码 (0x3F=前6轴, 0xFF=8轴)
    ...
    def move_free_path_dict(self, joints, speed_pct=50.0, ck_status=0x3F, one_shot=True):
        """自由路径 (从字典传参)
        joints: {"j1": ..., "j2": ..., ..., "j6": ...}
        """
    ...
    def _build_pose_line_inst(self, x, y, z, u, v, w,
        ...
        姿势直线: m0-m7 对应世界坐标 X,Y,Z,U,V,W,M7,M8
        """
        return {
            "oneshot": "1" if one_shot else "0",
            "action": "10",
